...
public class App {
    ...
    private final LinkedList<DefaultHelper> imgs;
    ...
    /**
     * Constructor del app a partir de una imagen.
     * @param imagen Imagen a procesar.
     */
    public App(BufferedImage imagen) {
        this.imagen = imagen;
    ...
    private void calculaDistancias(String nombre, BufferedImage img) {
        ...
        /* Guadamos las componentes r,g y b. y el nombre de la imagen en una
         lista. */
        double[] cols = {r, g, b};
        imgs.add(new DefaultHelper(nombre, cols));
    }
